...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  const platesData = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json"
...
let myStyle = {
  ...
  d3.json(platesData).then(function(data) {
    ...
    L.geoJSON(data).addTo(tetonicPlates, {
      style: myStyle
    });
